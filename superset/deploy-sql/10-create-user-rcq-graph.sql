...
-- GRANT UPDATE (spotfire_opened, spotfire_open_date) ON rcq.queteur_mailing_status TO 'rcq-graph'@'%';
-- GRANT UPDATE (thanks_mail_benevole, thanks_mail_benevole1j) ON rcq.ul_settings TO 'rcq-graph'@'%';
