...
Dashboard Superset embedded affichant l'objectif vs le réalisé pour l'année courante.Courbe cumulative du montant collecté par jour de quête, comparée à l'objectif.
