...
from .routers import health, auth, config, controle_donnees, embed, classement, classement_tronc, etats_troncs, map, money_bags, repartition_jours, stats_journalieres, superset, ul, yearly_goals
